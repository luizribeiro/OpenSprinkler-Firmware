...
#define OS_FW_VERSION                                                          \
  219 // Firmware version: 220 means 2.2.0
...
#define HW_TYPE_DC                                                             \
  0xDC // DC powered, for both DC and 24VAC solenoids, with boost converter and
       // MOSFETs
#define HW_TYPE_LATCH                                                          \
  0x1A // DC powered, for DC latching solenoids only, with boost converter and
       // H-bridges
...
#define NVCON_FILENAME                                                         \
  "nvcon.dat" // non-volatile controller data file, see OpenSprinkler.h -->
              // struct NVConData
...
#define FLOWCOUNT_RT_WINDOW                                                    \
  30 // flow count window (for computing real-time flow rate), 30 seconds
...
#define MAX_NUM_BOARDS                                                         \
  (1 + MAX_EXT_BOARDS) // maximum number of 8-zone boards including expanders
#define MAX_NUM_STATIONS (MAX_NUM_BOARDS * 8) // maximum number of stations
#define STATION_NAME_SIZE                                                      \
  32                       // maximum number of characters in each station name
...
#define PIN_SR_DATA_ALT                                                        \
  21 // shift register data pin (alternative, for RPi 1 rev. 1 boards)
