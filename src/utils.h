...
void write_to_file(const char *fname, const char *data, ulong size,
                   ulong pos = 0, bool trunc = true);
void read_from_file(const char *fname, char *data,
                    ulong maxsize = TMP_BUFFER_SIZE, int pos = 0);
...
void file_copy_block(const char *fname, ulong from, ulong to, ulong len,
                     void *tmp = 0);
